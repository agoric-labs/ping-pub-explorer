...
<template>
  ...
  <!-- 4rem is the width of the sidebar -->
  <div
    class="flex flex-col gap-y-4 grow max-w-full p-4 overflow-scroll w-full xl:max-w-[calc(100vw-4rem)]"
  >
    <!-- header -->
    <div
      class="bg-base-100 flex flex-shrink-0 h-16 items-center px-4 rounded sticky top-0 z-10"
    >
      <div
